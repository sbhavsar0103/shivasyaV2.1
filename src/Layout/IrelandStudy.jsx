...
import IrelandStudyBanner from "../assets/study/study-in-ireland.png";
import IrelandInfo from "../Layout/IrelandInfo";
import StudyInIreland from "../Layout/StudyInIreland";
import TopUniversitiesIreland from "../Layout/TopUniversitiesIreland";
import WhyChooseIreland from "../Layout/WhyChooseIreland";
import ContactForm from "../Layout/ContactUsForm";
import Footer from "../Layout/footer";

export default function IrelandStudy() {
    return (
        <>
