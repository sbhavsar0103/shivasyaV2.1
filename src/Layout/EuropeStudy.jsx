...
import StudyInEuropeImage from "../assets/study/study-in-europe.png";
import EuropeInfo from "../Layout/EuropeInfo";
import StudyInEurope from "../Layout/StudyInEurope";
import TypesEuropeStudentVisas from "../Layout/TypesEuropeStudentVisas";
import BestUniversitiesEurope from "../Layout/BestUniversitiesEurope";
import EuropeStudentVisaConsultant from "../Layout/EuropeStudentVisaConsultant";
import EuropeCountries from "../Layout/EuropeCountries";
...
export default function EuropeStudy() {
    return (
        <>
            ...
            <EuropeInfo />
            <StudyInEurope />
            <TypesEuropeStudentVisas />
            <BestUniversitiesEurope />
            <EuropeStudentVisaConsultant />
            <EuropeCountries />
            <ContactForm />
            <Footer />
        </>
