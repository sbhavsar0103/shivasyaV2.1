...
import StudyNewZealand from "../assets/study/study-in-new-zealand.png";
import NewZealandInfo from "../Layout/NewZealandInfo";
import StudyInNewZealand from "../Layout/StudyInNewZealand";
import DocumentsForNewZealandStudentVisa from "../Layout/DocumentsForNewZealandStudentVisa";
import BenefitsNewZealandStudentVisa from "../Layout/BenefitsNewZealandStudentVisa";
import ContactForm from "../Layout/ContactUsForm";
import Footer from "../Layout/footer";

export default function NewZealandStudy() {
    return (
        <>
            ...
            <NewZealandInfo />
            <StudyInNewZealand />
            <DocumentsForNewZealandStudentVisa />
            <BenefitsNewZealandStudentVisa />
            <ContactForm />
            <Footer />
        </>
    );
